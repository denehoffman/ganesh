...
//!
//! The `minimize!` macro exists to simplify the [`Minimizer<F, A, E>::minimize<Callback: Fn(&Self)>(&mut self, args: Option<&A>, steps: usize, callback: Callback) -> Result<(), E>`](`crate::core::Minimizer::minimize`) call if you don't actually want a callback or arguments.
#![warn(
    clippy::nursery,
    clippy::unwrap_used,
    clippy::expect_used,
