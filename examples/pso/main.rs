...
use ganesh::{
    algorithms::particles::{
        LegacyPSO, LegacyPSOConfig, Swarm, SwarmPositionInitializer, TrackingSwarmObserver,
    },
    core::{Callbacks, MaxSteps},
    traits::{Algorithm, LegacyCostFunction},
    DVector, Float, PI,
};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    impl LegacyCostFunction for Problem {
